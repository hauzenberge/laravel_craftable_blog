...
Route::namespace('App\Http\Controllers\WEB')->group(static function () {
    Route::get('/', 'BlogController@index');
    Route::get('/category/{category}', 'BlogController@getPostsByCategory');
    Route::get('/post/{id}', 'BlogController@getPost');

    Route::post('/post/{id}', 'BlogController@addComment');
});
