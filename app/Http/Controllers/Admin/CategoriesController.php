...
class CategoriesController extends Controller
{
    ...
    {
        $category_has_post_query = CategoryHasPost::where('category_id', $category->id);

        $category_has_post_ids = $category_has_post_query->get()
            ->map(function ($item) {
                return $item->post_id;
            })
            ->toArray();

        CategoryHasPost::where('category_id', $category->id)->delete();

        $category->delete();

        $category_has_post_query->delete();

        Post::whereIn('id', $category_has_post_ids)->delete();
        ...
        DB::transaction(static function () use ($request) {
            collect($request->data['ids'])
                ...
                ->each(static function ($bulkChunk) {
                    ...
                    $category_has_post_query = CategoryHasPost::whereIn('category_id', $bulkChunk);
                    ...
                    CategoryHasPost::whereIn('category_id', $bulkChunk)->delete();                    
